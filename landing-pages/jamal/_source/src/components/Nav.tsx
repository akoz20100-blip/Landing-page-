    ...
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      <div className="relative flex items-center justify-between px-5 py-4 md:px-8 md:py-6">
        <a
          ...
          data-cursor="link"
          className="relative z-50 block text-cream transition-opacity duration-200 hover:opacity-70"
        >
        ...
        <nav aria-label="Primary" className="hidden items-center gap-7 md:flex lg:gap-9">
          {LINKS.map((link) => (
            <a
              ...
              data-cursor="link"
              className="link-underline inline-flex min-h-[44px] items-center py-2 font-body text-sm tracking-wide text-cream"
            >
              {link.label}
            </a>
          ))}
        ...
        <button
          ...
          data-cursor="link"
          className="relative z-50 -mr-2 flex h-11 w-11 items-center justify-center text-cream md:hidden"
        >
