        ...
        <div ref={track} className="gallery-track flex shrink-0 items-center gap-5 md:gap-8">
          ...
          {SHOTS.map((shot, i) => (
            ...
            >
              ...
              />
              <figcaption className="pointer-events-none absolute bottom-0 left-0 z-[1] flex w-full items-center justify-between bg-gradient-to-t from-ink/90 to-transparent px-4 py-4">
